            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <form action="">
                        ...
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="password" placeholder="Enter your password" class="form-control my-2 p-2">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                                <input type="password" placeholder="Retype your password" class="form-control my-2 p-2">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
                        ...
                        <p>Don't have an account? <a href="{{url('login')}}">Login here here</a></p>
                    </form>
                </div>
            </div>
        </div>
